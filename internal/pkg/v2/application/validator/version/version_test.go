...
import (
	...
	dto "github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/dto/v2dot0/version"
...
func TestValidate(t *testing.T) {
	...
	variations := []struct {
	...
	}{
		{
			...
			expectedStatus:   application.StatusSuccess,
		},
		{
			name:    "invalid type",
		...
		t.Run(
			...
			func(t *testing.T) {
				result, status := Validate(
					...
					application.NewBehavior(application.Version2, application.KindVersion, application.ActionCommand),
