...
import (
	...
	"github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/validator/base"
	"github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/validator/behavior"
)
...
func Validate(
	...
	supportedBehaviors []*application.Behavior) (interface{}, application.Status) {
	...
	return nil, application.StatusSuccess
}
