...
import (
	...
	validator "github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/validator/metrics"
	"github.com/edgexfoundry/edgex-go/internal/pkg/v2/domain/metrics"
...
const (
	...
	kind     = application.KindMetrics
	action   = application.ActionCommand
	method   = api.ActionCommand
	endpoint = api.BaseURL + "/metrics"
)
