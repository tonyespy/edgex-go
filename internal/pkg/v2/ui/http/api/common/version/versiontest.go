...
import (
	...
	dtoV2dot0 "github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/dto/v2dot0/version"
		...
		application.Version2dot0: {
			{
				...
				expectedResponse: dtoV2dot0.NewResponse(dtoBaseV2dot0.NewResponseForSuccess(requestIDOne), application.VersionLatest),
			...
			},
			{
				...
				expectedResponse: []interface{}{
					dtoV2dot0.NewResponse(dtoBaseV2dot0.NewResponseForSuccess(requestIDOne), application.VersionLatest),
					dtoV2dot0.NewResponse(dtoBaseV2dot0.NewResponseForSuccess(requestIDTwo), application.VersionLatest),
				},
		...
		application.Version2dot0: {
			{
				...
				expectedResponse: []interface{}{batchdto.NewTestRequest(batchdto.NewCommon(application.Version2, kind, action, batchdto.StrategySynchronous), dtoV2dot0.NewResponse(dtoBaseV2dot0.NewResponseForSuccess(requestID), application.VersionLatest))},
				expectedStatus:   http.StatusMultiStatus,
			},
			{
				...
				expectedResponse: []interface{}{
					batchdto.NewTestRequest(batchdto.NewCommon(application.Version2, kind, action, batchdto.StrategySynchronous), dtoV2dot0.NewResponse(dtoBaseV2dot0.NewResponseForSuccess(requestID), application.VersionLatest)),
					batchdto.NewTestRequest(batchdto.NewCommon(application.Version2, kind, action, batchdto.StrategySynchronous), dtoV2dot0.NewResponse(dtoBaseV2dot0.NewResponseForSuccess(requestID), application.VersionLatest)),
				},
				expectedStatus: http.StatusMultiStatus,
			},
